...
public class OrganisationListAdapter extends BaseAdapter {
    ...
    public OrganisationListAdapter(Context context, ArrayList<String> values, ArrayList<String> numbers, ArrayList<String> images){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_organisations, parent, false);
